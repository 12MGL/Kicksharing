...
const API_BASE_URL =  "http://localhost:3000" || `${process.env.REACT_APP_API_URL.slice(0, -4)}3000`;  //делаем динамический ip, чтобы при подключении с внешних устройств, нас пускало на бэкенд
