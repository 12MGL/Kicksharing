...
CREATE TABLE `users` (
  ...
  `role` enum('admin','repairman') NOT NULL,
  ...
  CONSTRAINT `users_ibfk_1` FOREIGN KEY (`service_center_id`) REFERENCES `service_centers` (`id`)
...
-- Dump completed on 2025-01-28  0:22:20
